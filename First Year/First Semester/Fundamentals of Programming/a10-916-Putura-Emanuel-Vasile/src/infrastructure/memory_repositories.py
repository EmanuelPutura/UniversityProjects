...
from iterators.collection import Collection, filter_data
...
class Repository:
    ...
    def search_by_id(self, id):
        ...
        items = filter_data(self.__entities, lambda item: str(id).lower() in str(item.id).lower())
        return items
