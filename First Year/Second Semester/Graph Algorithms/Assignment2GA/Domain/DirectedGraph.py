...
class DirectedGraph:
    ...
    def breadthFirstSearch(self, start_vertex, destination_vertex):
        ...
        if destination_vertex not in distance:
            raise DirectedGraphException("There is no path from node {} to node {}!".format(start_vertex, destination_vertex))
        return distance[destination_vertex], self.__findBreadthFirstSearchPath(start_vertex, destination_vertex, previous)
