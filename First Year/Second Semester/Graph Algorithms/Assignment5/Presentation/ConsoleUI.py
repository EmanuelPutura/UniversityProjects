...
class ConsoleUI:
    def __init__(self):
        ...
        self.__commands = {"1": self.__createRandomGraph, "2": self.__readGraphFromTextFile, "3": self.writeGraphToTextFile, "4": self.getVerticesNo,
                           ...
                           "25": self.findMinimumVertexCoverBS, "26": self.findMinimumVertexCoverGreedy, "27": self.findMinimumVertexCoverApproximation}
    ...
    def findMinimumVertexCoverBS(self):
        ...
        try:
            graph = FileManager().read(file_path, UndirectedGraph)
            vertex_cover = graph.findMinimumVertexCoverBS()
            print("The minimum vertex cover is: {", end="")
            for node in vertex_cover:
                if node != vertex_cover[-1]:
    ...
    def findMinimumVertexCoverGreedy(self):
        ...
        try:
            graph = FileManager().read(file_path, UndirectedGraph)
            vertex_cover = graph.findMinimumVertexCoverGreedy()
            print("The minimum vertex cover is: {", end="")
            for node in vertex_cover:
                if node != vertex_cover[-1]:
                    print("{}, ".format(node), end="")
    ...
    def findMinimumVertexCoverApproximation(self):
        ...
        try:
            graph = FileManager().read(file_path, UndirectedGraph)
            vertex_cover = graph.findMinimumVertexCoverApproximation()
            print("The minimum vertex cover is: {", end="")
            for node in vertex_cover:
                if node != vertex_cover[-1]:
                    print("{}, ".format(node), end="")
    ...
    def __menu(self):
        ...
        print("25 - given an undirected graph, find a vertex cover of minimum size (approach 1, using binary search)\n26 - given an undirected graph, find a vertex cover of minimum size (approach 2,", end="")
        print("using a greedy algorithm)\n27 - given an undirected graph, find a vertex cover of minimum size (approach 3, using an approximation algorithm)\n28 - exit the application")
        print("-" * 90)
