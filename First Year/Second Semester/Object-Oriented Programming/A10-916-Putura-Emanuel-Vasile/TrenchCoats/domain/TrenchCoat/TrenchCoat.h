...
public:
    ...
    inline void setSize(const std::string& other) { size = other; }
    inline void setColour(const std::string& other) { colour = other; }
    inline void setPrice(const int& other) { price = other; }
    inline void setQuantity(const int& other) { quantity = other; }
    inline void setPhotograph(const std::string& other) { photograph = other; }
