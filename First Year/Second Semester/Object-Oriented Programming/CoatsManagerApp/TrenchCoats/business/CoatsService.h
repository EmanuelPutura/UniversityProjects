...
private:
    ...
    int payment = 0;
public:
    CoatsService(AbstractRepository<TrenchCoat>& repository, AbstractLaunchRepository<TrenchCoat>& shopping_basket, UndoRedoService& undo_redo_service) : IService(), repository(repository), shopping_basket(shopping_basket),
                                                validator(CoatValidator()), undo_redo_service(undo_redo_service) {
     ...
     */
    void add(const std::string& size, const std::string& colour, int price, int quantity, const std::string& photograph, bool ur_register=true) override;
    ...
    void update(const std::string& size, const std::string& colour, int price, const std::string& photograph, const std::string& new_size,
                const std::string& new_colour, int new_price, int new_quantity, const std::string& new_photograph, bool ur_register=true) override;
     ...
     * @param photograph: the photograph of the trench coat
     */
    void remove(const std::string& size, const std::string& colour, int price, const std::string& photograph, bool ur_register=true) override;
    ...
    */
     ...
     * @param size: the size of the trench coat
     */
    void addToShoppingBasket(const int& index, const std::string& size, bool ur_register = true) override;

    void removeFromShoppingBasket(TrenchCoat coat, bool ur_register = true) override;
