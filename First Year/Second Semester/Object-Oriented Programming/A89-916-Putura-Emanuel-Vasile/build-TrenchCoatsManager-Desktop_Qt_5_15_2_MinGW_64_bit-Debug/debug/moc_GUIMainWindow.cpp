...
#include <memory>
#include "../../TrenchCoatsManager/presentation/GUIMainWindow.h"
...
QT_MOC_LITERAL(1, 14, 10), // "flagChange"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "GUIMainWindow\0flagChange\0"
};
...
void GUIMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GUIMainWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GUIMainWindow::flagChange)) {
                *result = 0;
                return;
            }
        }
