...
int main(int argc, char *argv[])
{
    ...
    FileRepository<TrenchCoat> repository {"../TrenchCoatsManager/files/repository.txt"};
    AbstractLaunchRepository<TrenchCoat>* shopping_basket;
    Repository<UndoRedoFunction*> undo_redo_repository;

    CSVRepository<TrenchCoat> shopping_basket_csv("../TrenchCoatsManager/files/shopping_basket.csv");
    HTMLCoatsRepository shopping_basket_html("../TrenchCoatsManager/files/shopping_basket.html");
