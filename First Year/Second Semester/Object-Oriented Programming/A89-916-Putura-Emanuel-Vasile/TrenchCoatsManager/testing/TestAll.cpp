...
//    DatabaseCoatsRepository repo {"test1.db"};
//
//    std::cout << repo.getLength() << '\n';
//    TrenchCoat t1 {"T11", "T12", 11, 12, "T13"};
//    TrenchCoat t2 {"T21", "T22", 21, 22, "T23"};
//    TrenchCoat t3 {"T31", "T32", 31, 32, "T33"};
//
//
////    repo.add(t3);
//    repo.update(t2, t3);

//    TrenchCoat a {"a", "b", 1, 2, "c"};
//
//    try {
//        repo.add(a); }
...
//    }
//
//    TrenchCoat b {"aafa", "sgsgb", 3431, 42242, "cgsdds"};
//
//    try {
//        repo.add(b); }
//    catch (RepositoryException r) {
...
//    TrenchCoat c {"--------", "+++++", 0, 11111, "-------"};
//
//    try {
//        repo.update(a, c);
//    }
//    catch (RepositoryException r) {std::cout << r.getMessage() << '\n';}
