...
#include <memory>
#include "../../CodeRevision/presentation/programmerwindow.h"
...
struct qt_meta_stringdata_ProgrammerWindow_t {
    QByteArrayData data[7];
    char stringdata0[103];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ProgrammerWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProgrammerWindow_t qt_meta_stringdata_ProgrammerWindow = {
    {
QT_MOC_LITERAL(0, 0, 16), // "ProgrammerWindow"
QT_MOC_LITERAL(1, 17, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(4, 64, 20), // "on_tableView_clicked"
QT_MOC_LITERAL(5, 85, 11), // "QModelIndex"
QT_MOC_LITERAL(6, 97, 5) // "index"

    },
    "ProgrammerWindow\0on_pushButton_clicked\0"
    "\0on_pushButton_2_clicked\0on_tableView_clicked\0"
    "QModelIndex\0index"
};
...
QT_INIT_METAOBJECT const QMetaObject ProgrammerWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ProgrammerWindow.data,
    qt_meta_data_ProgrammerWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ProgrammerWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProgrammerWindow.stringdata0))
