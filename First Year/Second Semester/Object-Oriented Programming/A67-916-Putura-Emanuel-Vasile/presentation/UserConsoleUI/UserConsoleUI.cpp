...
void UserConsoleUI::menu() const {
    ...
    table.addRow(2, "show", "show shopping basket using external program");
...
int UserConsoleUI::mapCommand(const std::string &command) const {
    std::string commands[] = {"display", "shopping basket", "show", "switch", "exit", "add", "!add", "stop"};
    int int_commands[] = {0, 1, 2, 3, 4, 5, 6, 7};
...
void UserConsoleUI::showShoppingBasketFile() const {
