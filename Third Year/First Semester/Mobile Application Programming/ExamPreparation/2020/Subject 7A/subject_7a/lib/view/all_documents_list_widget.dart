...
class AllDocumentsListWidget extends StatefulWidget {
  const AllDocumentsListWidget({Key? key}) : super(key: key);

  @override
  State<AllDocumentsListWidget> createState() => _AllDocumentsListWidget();
}

class _AllDocumentsListWidget extends State<AllDocumentsListWidget> {
  Widget _buildListView() {
    var entitiesFuture = Provider.of<DbRepository>(context, listen: true).getAllDocuments();
