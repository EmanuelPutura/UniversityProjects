...
import 'package:subject_2b/view/category_activities_section.dart';
...
class _CategoriesListWidget extends State<CategoriesListWidget> {
  Widget _buildListView() {
    var httpOutMessageFuture = Provider.of<DbRepository>(context, listen: true).getAllCategories();

    return FutureBuilder<HttpOutMessage<List<String>>>(
                      ...
                      onTap: () => {
                        Navigator.of(context).push(
                            MaterialPageRoute<void>(
                                builder: (context) {
                                  return CategoryActivitiesSection(entity);
                                }
                            )
                        )
                      }
