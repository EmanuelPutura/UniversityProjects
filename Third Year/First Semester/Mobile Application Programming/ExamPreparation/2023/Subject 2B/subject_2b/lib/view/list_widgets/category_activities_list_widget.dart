...
import '../delete_activity_section.dart';

class CategoryActivitiesListWidget extends StatefulWidget {
  final String _category;

  const CategoryActivitiesListWidget(this._category, {Key? key}) : super(key: key);

  @override
  State<CategoryActivitiesListWidget> createState() => _CategoryActivitiesListWidget();
}

class _CategoryActivitiesListWidget extends State<CategoryActivitiesListWidget> {
  Widget _buildListView() {
    var httpOutMessageFuture = Provider.of<DbRepository>(context, listen: true).getAllActivitiesWithCategory(widget._category);
    ...
    return FutureBuilder<HttpOutMessage<List<Activity>>>(
        ...
        builder: (context, snapshot) {
          ...
          var httpOutMessage = snapshot.data;
                  ...
                  child: ListTile(
                      ...
                      onTap: () => {
                        Navigator.of(context).push(MaterialPageRoute<void>(
                            builder: (context) {
                              return DeleteActivitySection(entity);
                            }
                        ))
                      }
                  ),
