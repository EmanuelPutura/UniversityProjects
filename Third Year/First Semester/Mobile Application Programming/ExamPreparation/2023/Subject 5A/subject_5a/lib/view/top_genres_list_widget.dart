...
class TopGenresListWidget extends StatefulWidget {
  const TopGenresListWidget({Key? key}) : super(key: key);

  @override
  State<TopGenresListWidget> createState() => _TopGenresListWidget();
}

class _TopGenresListWidget extends State<TopGenresListWidget> {
  Widget _buildListView() {
    var entitiesFuture = Provider.of<DbRepository>(context, listen: true).getMostPopularGenresList();
