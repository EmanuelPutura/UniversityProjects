...
class TopListWidget extends StatefulWidget {
  ...
  @override
  State<TopListWidget> createState() => _TopListWidget();
}

class _TopListWidget extends State<TopListWidget> {
  Widget _buildListView() {
    var httpOutMessageFuture = Provider.of<DbRepository>(context, listen: true).getTopThreeCategories();
