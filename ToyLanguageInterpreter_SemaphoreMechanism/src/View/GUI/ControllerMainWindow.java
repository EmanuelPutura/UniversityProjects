...
public class ControllerMainWindow {
    ...
    @FXML
    private TableView<Map.Entry<Integer, Pair<Integer, List<Integer>>>> semaphore_table_view;

    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> semaphore_location_column;

    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> semaphore_value_column;

    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, List<Integer>> semaphore_list_column;
    ...
    private void applyRepositoryModifications() {
        ...
        ObservableList<Map.Entry<Integer, Pair<Integer, List<Integer>>>> semaphore_obs = FXCollections.observableArrayList();
        semaphore_obs.addAll(controller.getRepository().getInitialProgramState().semaphoreTable().getContent().entrySet());
        semaphore_table_view.setItems(semaphore_obs);
        semaphore_table_view.refresh();
    ...
    public void initialize() {
        ...
        semaphore_location_column.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer>, ObservableValue<Integer>>() {
            @Override
        ...
        semaphore_value_column.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer>, ObservableValue<Integer>>() {
            @Override
            public ObservableValue<Integer> call(TableColumn.CellDataFeatures<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> entry) {
                Map.Entry<Integer, Pair<Integer, List<Integer>>> map_entry = entry.getValue();
        ...
        semaphore_list_column.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<Map.Entry<Integer, Pair<Integer, List<Integer>>>, List<Integer>>, ObservableValue<List<Integer>>>() {
            @Override
