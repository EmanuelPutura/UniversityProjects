...
public class ProgramState {
    ...
    private IADTSemaphoreTable semaphore_table;
    ...
    public ProgramState(IADTStack<IStatement> exec_stack, IADTDictionary<String, IValue> sym_table, IADTList<IValue> out_list,
                        ...
                        IADTSemaphoreTable semaphore_table, IStatement statement) {
    ...
    public IADTSemaphoreTable semaphoreTable() {
    ...
    public void setSemaphoreTable(IADTSemaphoreTable other) {
        semaphore_table = other;
    }
