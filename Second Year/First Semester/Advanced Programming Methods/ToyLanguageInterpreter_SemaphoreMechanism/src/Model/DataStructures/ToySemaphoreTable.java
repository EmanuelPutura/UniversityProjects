...
public class ToySemaphoreTable extends ToyDictionary<Integer, Pair<Integer, List<Integer>>> implements IADTSemaphoreTable {
    ...
    public void put(Integer key, Pair<Integer, List<Integer>> value) throws DictionaryException {
        if (!key.equals(next_free_location))
            throw new DictionaryException("Invalid semaphore table location!");
        super.put(key, value);
        synchronized (this) {
            next_free_location++;
        }
