...
class ConsoleCommandsSensorsOrderEnergy:
    ...
    def runAlgorithmCommand(self):
        ...
        print("How much more energy do you want to give to the drone (without considering the paths between sensors)?")
        ...
        print("The road between the sensors takes {} energy.".format(consumedEnergy))
